...
> Type: `general`
> Updated: `2026-08-14`
> Summary: 固定 headless / vscode、用户可见 codex / claude / agy / grok / vscode mode、以及兼容 alias 的仓库级术语边界。
...
- `codex vs claude vs agy vs grok`
...
2. 再看 backend 是 `codex`、`claude`、`agy` 还是 `grok`
